                ...
                <section class="col-span-8 col-start-5 mt-10 space-y-6">
                    ...
                    <form method="POST" action="#">
                        ...
                        <header class="flex items-center">
                            ...
                            <h2 class="ml-4">Want to participe?</h2>
                        </header>
                        <div class="mt-6">
                            <textarea class="w-full text-sm focus:outline:none focus:ring" name="body" id="" cols="30" rows="5" placeholder="Quick, think of something to say!"></textarea>
                        </div>
